...
// Lightweight lucide-style stroke icons so we don't pull in a dependency.
const paths: Record<string, React.ReactNode> = {
  ...
  flame: (
    <path d="M12 3c1 3 4 4 4 8a4 4 0 0 1-8 0c0-1 .5-2 1-2.5C9 11 9 12 10 12c0-2-1-3 2-9Z" />
  ),
  star: (
